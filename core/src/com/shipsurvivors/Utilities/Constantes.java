...
public class Constantes {
    ...
    public final static float CARD_WIDTH = 80;
    ...
    public final static float SHIP_HEIGHT = 184;
    public final static float SHIP_WIDTH = 313;
    public final static float WHEEL_WIDTH = 144;
